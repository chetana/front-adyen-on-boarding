...
REGION="europe-west1"
SERVICE_NAME="adyen-onboarding-frontend"

echo "🚀 Déploiement de l'application Adyen Onboarding sur Cloud Run..."
...
echo "🔗 Votre application est disponible à l'adresse : $SERVICE_URL"
